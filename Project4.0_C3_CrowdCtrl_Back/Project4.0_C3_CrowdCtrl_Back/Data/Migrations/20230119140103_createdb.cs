        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventRecordingDeviceId = table.Column<int>(type: "int", nullable: false),
                    MoodTypeId = table.Column<int>(type: "int", nullable: false),
                    IncidentTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incident_MoodType_MoodTypeId",
                        column: x => x.MoodTypeId,
                        principalTable: "MoodType",
                        principalColumn: "MoodTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incident_RecordingDevice_EventRecordingDeviceId",
                        column: x => x.EventRecordingDeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventRecordingDevice", x => x.EventRecordingDeviceId);
                    table.ForeignKey(
                        name: "FK_EventRecordingDevice_Event_EventId",
                        column: x => x.EventId,
                        principalTable: "Event",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventRecordingDevice_RecordingDevice_RecordingDeviceId",
                        column: x => x.RecordingDeviceId,
                        principalTable: "RecordingDevice",
                        principalColumn: "RecordingDeviceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventRecordingDevice_Zone_ZoneId",
                        column: x => x.ZoneId,
                        principalTable: "Zone",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mood_EventRecordingDevice_EventRecordingDeviceId",
                        column: x => x.EventRecordingDeviceId,
                        principalTable: "EventRecordingDevice",
                        principalColumn: "EventRecordingDeviceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Mood_MoodType_MoodTypeId",
                        column: x => x.MoodTypeId,
                        principalTable: "MoodType",
                        principalColumn: "MoodTypeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRecordingDevice_EventId",
                table: "EventRecordingDevice",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventRecordingDevice_RecordingDeviceId",
                table: "EventRecordingDevice",
                column: "RecordingDeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_EventRecordingDevice_ZoneId",
                table: "EventRecordingDevice",
                column: "ZoneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incident_EventRecordingDeviceId",
                table: "Incident",
                column: "EventRecordingDeviceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incident_MoodTypeId",
                table: "Incident",
                column: "MoodTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Mood_EventRecordingDeviceId",
                table: "Mood",
                column: "EventRecordingDeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_Mood_MoodTypeId",
                table: "Mood",
                column: "MoodTypeId");
        }
